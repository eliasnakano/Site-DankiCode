...
<section class="slider">
    <div class="carousel">
        <div><img class="prim-img" src="img/amazon.jpg" alt="drone">
        </div>
        <div><img class="seg-img" src="img/dominos.jpg" alt="keybord">
        </div>
        <div><img class="ter-img" src="img/uber.jpg" alt="keybord">
        </div>
        <div>
            <img class="qui-img" src="img/walmart.jpg" alt="keybord">
        </div>
        <div><img class="qua-img" src="img/costco.jpg" alt="keybord">
        </div>
        <div><img class="prim-img" src="img/amazon.jpg" alt="drone">
        </div>
        <div><img class="seg-img" src="img/dominos.jpg" alt="keybord">
